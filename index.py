...
app.layout=html.Div(children=[html.H1('Covid-19 Colombia',style= {'text-align':'center'}),
                    ...
                    html.H2('Estado de los contagiados',style= {'text-align':'center'}),
                    dcc.Graph(id='graph2',figure=px.pie(df_estado,values='Cant',names=df_estado.index)),
                    html.H2( 'Atencion de los contagiados',style= {'text-align':'center'}),      
                    dcc.Graph(id='graph3',figure=px.pie(df_atencion,values='Casos',names='atenci_n',hole=0.3)),
